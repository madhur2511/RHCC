...
public class Main {
	...
	public void showPopup() {
        ...
        if(result == JOptionPane.OK_OPTION){        	
        	try {
        		String usernamename = username_TA.getText();        	
            	String groupname = groupname_TA.getText();
				...
				public void run()
				{
					...
					while(begin == true)
					{
						synchronized(begin){
					        ...
					        Mat frameTempInternal = new Mat(480,640,CvType.CV_8UC3);
					        ...
					        synchronized(webclient)
					        {
							    ...
							    ip3.updateImage(bufImageInternal);
					        }						    					   
						}
			        }
				}
	...
	private void save()
	{
		...
		if(savimg != null)
		{
			...
			Mat saveframe = new Mat(480,640, CvType.CV_8UC3);
